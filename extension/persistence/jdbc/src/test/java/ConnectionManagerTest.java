...
public class ConnectionManagerTest {
  ...
  //  @Test
  //  public void testGetConnection_successfulConnection() throws SQLException,IOException {
  ...
  //
  //  @Test
  //  public void testGetConnection_successfulConnectionX() throws SQLException, IOException {
  ...
  //    BasicDataSource mockDataSource = mock(BasicDataSource.class);
  //    when(mockDataSource.getConnection()).thenThrow(new SQLException("Database connection
  // failed"));
  //
  //    // Replace the static dataSource with the mockDataSource using Mockito's MockedStatic
  //    try (MockedStatic<ConnectionManager> mockedConnectionManager =
  ...
  //  }
  //
  //  // You may add more test cases for edge cases, such as testing the configuration of the
  //  // BasicDataSource.
  //  @Test
